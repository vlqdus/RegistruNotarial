...
for i, text in enumerate(labels_text):
    ...
    if text == "Denumire act":
        ...
        entry = tk.Entry(frame_formular, width=60, font=font_base, bd=1, relief="solid", bg="#2c2f33", fg="white", insertbackground="white")
...
entry_cautare = tk.Entry(frame_cautare, width=40, font=font_base, bd=1, relief="solid", bg="#444", fg="white", insertbackground="white")
